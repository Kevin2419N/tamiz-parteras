    ...
    return (
        <div className="min-h-screen bg-slate-100/80 text-slate-800 flex flex-col md:flex-row selection:bg-emerald-600 selection:text-white">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="bg-white border-b border-slate-200 px-4 sm:px-6 py-3 sticky top-0 z-20 flex items-center justify-between gap-4 shadow-sm">
                    ...
                    <div className="hidden sm:flex items-center gap-3">
                        ...
                        <span className="px-2.5 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider bg-emerald-50 text-emerald-800 border border-emerald-200">
                        ...
                        <Link
                            to="/notificaciones"
                            className="relative p-2 text-slate-600 hover:text-slate-900 bg-slate-50 border border-slate-200 rounded-xl hover:border-emerald-500/40 transition-colors"
